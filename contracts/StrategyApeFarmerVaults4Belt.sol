...
// File contracts/StrategyBelt.sol
...
contract StrategyBelt is Ownable, ReentrancyGuard, Pausable, IStrategy {
    ...
    address public buyBackAddress = 0x45BCAd5e65f7BCEB5C01C087a093db03A8279786;
    uint256 public entranceFeeFactor = 1000; // < 0.1% entrance fee - goes to pool + prevents front-running
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(nativeFarmAddress, wantAmtWithFee);
